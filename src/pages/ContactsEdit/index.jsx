...
import { Wrapper, Header, Title, FormEdit, AddBtn, InputSend } from "./styles";
  ...
  return (
    <Wrapper>
      ...
      <Grid container spacing={3}>
        <Grid item md={6} className="container-cards">
          <Title>
            <h5>Informações</h5>
          </Title>
        ...
        <Grid container item md={6} className="cols-right">
          <Grid item className="container-cards">
            Inteção de compra
          </Grid>
          <Grid item className="container-cards">
            Inteção de venda
